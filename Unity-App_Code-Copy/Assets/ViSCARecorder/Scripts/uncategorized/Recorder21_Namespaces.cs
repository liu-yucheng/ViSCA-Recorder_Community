...
namespace ViSCARecorder.Recorder21_
{
    [Serializable]
    ...
    public class __
    {
        ...
        public static void FilterContinuousEMA(
            in float idealAlpha,
            in float idealIntervalSeconds,
            in float actualIntervalSeconds,
            in Vector3 currentRaw,
            in Vector3 previous,
            out Vector3 filtered
        )
        {
            float rectifiedExponent = actualIntervalSeconds / idealIntervalSeconds;
            float rectified1MinusAlpha = (float)Math.Pow(1 - idealAlpha, rectifiedExponent);
            float rectifiedAlpha = 1 - rectified1MinusAlpha;
            filtered = rectifiedAlpha * currentRaw + rectified1MinusAlpha * previous;
        }
...
namespace ViSCARecorder.Recorder21_.Face
{
...
namespace ViSCARecorder.Recorder21_.Record
{
    [Serializable]
    ...
    public class Checkpoint
    {
        ...
        public Color color_type1 = Color.white;
        public Color color_type2 = Color.black;
        public string color_name_type1 = nameof(Color.white);
        public string color_name_type2 = nameof(Color.black);
        ...
        public Checkpoint(Checkpoint original)
        {
            index = original.index;
            count_total = original.count_total;
            count_type1 = original.count_type1;
            count_type2 = original.count_type2;
            color_type1 = original.color_type1;
            color_type2 = original.color_type2;
            color_name_type1 = original.color_name_type1;
            color_name_type2 = original.color_name_type2;
        }

        public void ProcessWith(in Checkpoint previous, in Record currentRecord)
        {
            // Do nothing.
        }
    }
    ...
    public class SpatialPose
    {
        ...
        )
        {
            ...
            Recorder21_.__.FindEulerAnglesDiff(previous.raw_rotation, current.raw_rotation, out Vector3 rotationDiff);
        ...
        {
            Recorder21_.__.FilterEMA(0.5f, current.raw_position, previous.position, out current.position);
            Recorder21_.__.FilterEMA(0.5f, current.raw_rotation, previous.rotation, out current.rotation);
            Recorder21_.__.FilterEMA(0.5f, current.raw_velocity, previous.velocity, out current.velocity);
            Recorder21_.__.FilterEMA(0.5f, current.raw_angular_velocity, previous.angular_velocity, out current.angular_velocity);
            Recorder21_.__.FilterEMA(0.5f, current.raw_acceleration, previous.acceleration, out current.acceleration);
            Recorder21_.__.FilterEMA(0.5f, current.raw_angular_acceleration, previous.angular_acceleration, out current.angular_acceleration);
        }
        ...
        {
            Recorder21_.__.FilterContinuousEMA(
                0.5f,
        ...
        public void ProcessWith(in SpatialPose previous, in Record currentRecord)
        {
            ...
            FilterContinuousEMAWith(
                previous,
                currentRecord.timestamp.ideal_record_interval_seconds,
                currentRecord.timestamp.actual_record_interval_seconds,
                this
            );
...
namespace ViSCARecorder.Recorder21_.Capture
{
    ...
    public class CaptureTask
    {
        ...
        private void FindPath(in string extension, out string path)
        {
            ...
            float folderTimeUS = folderTimeSeconds * 1_000_000;
            int folderTimeUSInt = (int)folderTimeUS;
            string fileName = $"{folderTimeUSInt:d11}{extension}";
            Recorder21_.__.ReplaceInvalidCharsWith("_", ref fileName);
