...
namespace ViSCARecorder.Recorder20_
{
    [Serializable]
...
namespace ViSCARecorder.Recorder20_.Face
{
...
namespace ViSCARecorder.Recorder20_.Record
{
    [Serializable]
    ...
    public class Timestamp
    {
        ...
        public float fixed_delta_time_seconds = 0f;
        public float record_delta_time_seconds = 0f;
        ...
        public Timestamp(Timestamp original)
        {
            ...
            fixed_delta_time_seconds = original.fixed_delta_time_seconds;
            record_delta_time_seconds = original.record_delta_time_seconds;
        }
    ...
    public class SpatialPose
    {
        ...
        )
        {
            ...
            Recorder20_.__.FindEulerAnglesDiff(previous.rotation_raw, current.rotation_raw, out Vector3 rotationDiff);
            ...
            Recorder20_.__.FilterEMA(0.5f, positionRaw, previous.position, out current.position);
            Recorder20_.__.FilterEMA(0.5f, rotationRaw, previous.rotation, out current.rotation);
            Recorder20_.__.FilterEMA(0.5f, velocityRaw, previous.velocity, out current.velocity);
            Recorder20_.__.FilterEMA(0.5f, angularVelocityRaw, previous.angular_velocity, out current.angular_velocity);
            Recorder20_.__.FilterEMA(0.5f, accelerationRaw, previous.acceleration, out current.acceleration);
            Recorder20_.__.FilterEMA(0.5f, angluarAccelerationRaw, previous.angular_acceleration, out current.angular_acceleration);
        }
        ...
        public void ProcessWith(in SpatialPose previous, in Record currentRecord)
        {
            ...
            FindDerivativesWith(
                previous,
                currentRecord.timestamp.fixed_delta_time_seconds,
                this
            );
        }
    }
...
namespace ViSCARecorder.Recorder20_.Capture
{
    public class CaptureTask
    {
        ...
        private void FindPath(out string path)
        {
            ...
            string fileName = $"{folderTimeUSInt:d11}.png";
            Recorder20_.__.ReplaceInvalidCharsWith("_", ref fileName);
