...
using ViSCARecorder.Recorder22_.Record;

namespace ViSCARecorder.Recorder22_
{
    [Serializable]
...
namespace ViSCARecorder.Recorder22_.Face
{
...
namespace ViSCARecorder.Recorder22_.Record
{
    [Serializable]
    ...
    public class SpatialPose
    {
        ...
        )
        {
            ...
            Recorder22_.__.FindEulerAnglesDiff(previous.raw_rotation, current.raw_rotation, out Vector3 rotationDiff);
        ...
        {
            float alpha = 0.5f;
            Recorder22_.__.FilterEMA(alpha, current.raw_position, previous.position, out current.position);
            Recorder22_.__.FilterEMA(alpha, current.raw_rotation, previous.rotation, out current.rotation);
            Recorder22_.__.FilterEMA(alpha, current.raw_velocity, previous.velocity, out current.velocity);
            Recorder22_.__.FilterEMA(alpha, current.raw_angular_velocity, previous.angular_velocity, out current.angular_velocity);
            Recorder22_.__.FilterEMA(alpha, current.raw_acceleration, previous.acceleration, out current.acceleration);
            Recorder22_.__.FilterEMA(alpha, current.raw_angular_acceleration, previous.angular_acceleration, out current.angular_acceleration);
        }
        ...
        {
            Recorder22_.__.FilterContinuousEMA(
                alphaIdeal,
                timeIntervalIdeal,
                timeIntervalActual,
        ...
        public void ProcessWith(in SpatialPose previous, in Record currentRecord)
        {
            ...
            Recorder22_.__.ContinuousEMAFindConfigs(
...
namespace ViSCARecorder.Recorder22_.Capture
{
    ...
    public class CaptureTask
    {
        ...
        private void FindPath(in string extension, out string path)
        {
            ...
            Recorder22_.__.ReplaceInvalidCharsWith(".", ref fileName);
