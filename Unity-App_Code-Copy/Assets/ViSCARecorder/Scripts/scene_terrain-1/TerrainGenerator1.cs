...
using ViSCARecorder.TerrainGenerator1_;
...
namespace ViSCARecorder
{
    public class TerrainGenerator1 : MonoBehaviour
    {
        ...
        private float Terrain_Noise_Frequency = 6f;
