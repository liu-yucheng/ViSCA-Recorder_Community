...
namespace ViSCARecorder.Recorder24_
{
    [Serializable]
...
namespace ViSCARecorder.Recorder24_.Face
{
...
namespace ViSCARecorder.Recorder24_.Record
{
    [Serializable]
    ...
    public class SpatialPose
    {
        ...
        )
        {
            ...
            Recorder24_.__.FindEulerAnglesDiff(previous.raw_rotation, current.raw_rotation, out Vector3 rotationDiff);
        ...
        {
            float alpha = 0.5f;
            Recorder24_.__.FilterEMA(alpha, current.raw_position, previous.position, out current.position);
            Recorder24_.__.FilterEMA(alpha, current.raw_rotation, previous.rotation, out current.rotation);
            Recorder24_.__.FilterEMA(alpha, current.raw_velocity, previous.velocity, out current.velocity);
            Recorder24_.__.FilterEMA(alpha, current.raw_angular_velocity, previous.angular_velocity, out current.angular_velocity);
            Recorder24_.__.FilterEMA(alpha, current.raw_acceleration, previous.acceleration, out current.acceleration);
            Recorder24_.__.FilterEMA(alpha, current.raw_angular_acceleration, previous.angular_acceleration, out current.angular_acceleration);
        }
        ...
        {
            Recorder24_.__.FilterContinuousEMA(
                alphaIdeal,
                timeIntervalIdeal,
                timeIntervalActual,
        ...
        public void ProcessWith(in SpatialPose previous, in Record currentRecord)
        {
            ...
            Recorder24_.__.ContinuousEMAFindConfigs(
    ...
    {
        public static Color colorSpecialsRed = new(0.8f, 0.5f, 0.5f, 1f);
        public static Color colorSpecialsGreen = new(0.5f, 0.8f, 0.5f, 1f);
        public static Color colorSpecialsBlue = new(0.5f, 0.5f, 0.8f, 1f);
...
namespace ViSCARecorder.Recorder24_.Capture
{
    ...
    public class CaptureTask
    {
        ...
        private void FindPath(in string extension, out string path)
        {
            ...
            Recorder24_.__.ReplaceInvalidCharsWith(".", ref fileName);
