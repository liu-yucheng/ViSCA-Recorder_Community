...
using ViSCARecorder.Recorder24_;

using Face = ViSCARecorder.Recorder24_.Face;
using Record = ViSCARecorder.Recorder24_.Record;
using Capture = ViSCARecorder.Recorder24_.Capture;


namespace ViSCARecorder
{
    public class Recorder24 : MonoBehaviour
    {
        // Shared (public).
        ...
        private void Start_Texts()
        {
            ...
            string debugOutputString =
                "- begin ViSCARecorder.Recorder24.Start\n"
                + "\n"
                + "record: {...}\n"
                + "\n"
                + "- end ViSCARecorder.Recorder24.Start\n"
            ;
        ...
        private void FixedUpdate_Texts()
        {
            ...
            if (text_DebugUpdateCountdown <= time_FixedDeltaTimeSeconds)
            {
                ...
                string debugOutputString =
                    $"- begin ViSCARecorder.Recorder24.FixedUpdate\n"
                    + $"\n"
                    + $"{recordString}\n"
                    + $"\n"
                    + $"- end ViSCARecorder.Recorder24.FixedUpdate\n"
                ;
        ...
        private void FixedUpdate_Record()
        {
            ...
            if (record_UpdateCountdown < 0f)
            {
                ...
                record_Current.recorder_name = nameof(Recorder24);
