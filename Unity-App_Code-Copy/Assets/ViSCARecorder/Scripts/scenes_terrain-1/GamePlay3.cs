...
namespace ViSCARecorder {
    public class GamePlay3 : MonoBehaviour
    {
        ...
        private bool GameConfigs_StandardApply_Needed = true;

        private Recorder24 Recorder_;
        private float Recorder_Refresh_Interval_Seconds = 0.033_333_333f; // 30 Hz.
        private float Recorder_Refresh_Countdown_Seconds = 0f;

        private TerrainGenerator1 TerrainGenerator;
        ...
        private bool TerrainGenerator_Generate_Needed = false;

        private Vehicle3 Vehicle_;
        ...
        private bool Autopilot_RandomSeedAutopilot_Reset_Needed = false;
        private bool Autopilot_RandomSpecialsIndex_Reset_Needed = false;
        ...
        private Recorder24_.Record.Specials RandomSeedSpecials_SpecialsInstance;
        ...
        {
            UserIndex_Value_Processed = GameConfigs1.UserIndex;
            PresetIndex_Value_Processed = GameConfigs1.PresetIndex;
            VehicleOpacity_Normalized = GameConfigs1.VehicleOpacity;
            AutopilotToggle_Enabled = GameConfigs1.AutopilotEnabled;
            RandomSeedTerrain_Value_Processed = GameConfigs1.RandomSeed_Terrain;
            RandomSeedAutopilot_Value_Processed = GameConfigs1.RandomSeed_Autopilot;
            RandomSeedSpecials_Value_Processed = GameConfigs1.RandomSeed_Specials;
            RandomSeedSpecials_SpecialsIndex = GameConfigs1.Specials_Index;
            RandomSeedSpecials_SpecialsInstance = GameConfigs1.Specials_Instance;
        }
        ...
        private void GameConfigs_Refresh()
        {
            ...
            if (GameConfigs_Refresh_Countdown_Seconds < Time.fixedDeltaTime)
            {
                ...
                GameConfigs1.UserIndex = UserIndex_Value_Processed;
                GameConfigs1.PresetIndex = PresetIndex_Value_Processed;
                GameConfigs1.VehicleOpacity = VehicleOpacity_Normalized;
                GameConfigs1.AutopilotEnabled = AutopilotToggle_Enabled;
                GameConfigs1.RandomSeed_Terrain = RandomSeedTerrain_Value_Processed;
                GameConfigs1.RandomSeed_Autopilot = RandomSeedAutopilot_Value_Processed;
                GameConfigs1.RandomSeed_Specials = RandomSeedSpecials_Value_Processed;
                GameConfigs1.Specials_Index = RandomSeedSpecials_SpecialsIndex;
                GameConfigs1.Specials_Instance = RandomSeedSpecials_SpecialsInstance;
            }
        }
        ...
        {
            Recorder_ = Recorder_Object.GetComponent<Recorder24>();
        }
        ...
        private void Recorder_Refresh()
        {
            ...
            if (Recorder_Refresh_Countdown_Seconds < Time.fixedDeltaTime)
            {
                ...
                {
                    Recorder_.record_Current.game_configs.user_index = GameConfigs1.UserIndex;
                    Recorder_.record_Current.game_configs.preset_index = GameConfigs1.PresetIndex;
                    Recorder_.record_Current.game_configs.vehicle_opacity = GameConfigs1.VehicleOpacity;
                    Recorder_.record_Current.game_configs.autopilot_enabled = GameConfigs1.AutopilotEnabled;
                    Recorder_.record_Current.game_configs.random_seed_terrain = GameConfigs1.RandomSeed_Terrain;
                    Recorder_.record_Current.game_configs.random_seed_autopilot = GameConfigs1.RandomSeed_Autopilot;
                    Recorder_.record_Current.game_configs.random_seed_specials = GameConfigs1.RandomSeed_Specials;
                    Recorder_.record_Current.game_configs.specials_index = GameConfigs1.Specials_Index;

                    if (GameConfigs1.Specials_Instance != null)
                    {
                        Recorder_.record_Current.game_configs.specials = new(GameConfigs1.Specials_Instance);
                    }
        ...
        {
            TerrainGenerator = TerrainGenerator_Object.GetComponent<TerrainGenerator1>();
        }
        ...
        {
            Vehicle_ = Vehicle_Object.GetComponent<Vehicle3>();
        }
        ...
        {
            Autopilot = Autopilot_Object.GetComponent<Autopilot2>();
        }
        ...
        private void UserIndex_Scrollbar_Sync()
        {
        ...
        private void PresetIndex_Scrollbar_Sync()
        {
        ...
        {
            VehicleOpacity_Reset(VehicleOpacity_Scrollbar.value);
        }
        ...
        private void RandomSeedSpecials_Scrollbar_OnValueChanged(float Value)
        {
            ...
            RandomSeedSpecials_SpecialsIndex = Random.Range(0, Recorder24_.Record.SpecialsStandards.standards.Count);
