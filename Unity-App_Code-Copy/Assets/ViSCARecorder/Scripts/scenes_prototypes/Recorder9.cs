...
using ViSCARecorder;
using ViSCARecorder.Recorder9NameSpace;

namespace ViSCARecorder
{
    public class Recorder9 : MonoBehaviour
    {
        ...
        private void StartDebugOut()
        {
            ...
            string debugOutString =
                "- begin ViSCARecorder.Recorder9.Start\n"
                + "\n"
                + "record: {...}\n"
                + "\n"
                + "- end ViSCARecorder.Recorder9.Start\n"
            ;
        ...
        private void FixedUpdateDebugOut()
        {
            ...
            string debugOutString =
                $"- begin ViSCARecorder.Recorder9.FixedUpdate\n"
                + $"\n"
                + $"{recordString}\n"
                + $"\n"
                + $"- end ViSCARecorder.Recorder9.FixedUpdate\n"
            ;
        ...
        private void FixedUpdateRecording2()
        {
