...
using ViSCARecorder.Recorder19_;
using Face = ViSCARecorder.Recorder19_.Face;
using Record = ViSCARecorder.Recorder19_.Record;
using Capture = ViSCARecorder.Recorder19_.Capture;

namespace ViSCARecorder
{
    public class Recorder19 : MonoBehaviour
    {
        // Shared (public).
        ...
        private void Start_Texts()
        {
            ...
            string debugOutputString =
                "- begin ViSCARecorder.Recorder19.Start\n"
                + "\n"
                + "record: {...}\n"
                + "\n"
                + "- end ViSCARecorder.Recorder19.Start\n"
            ;
        ...
        private void FixedUpdate_Texts()
        {
            ...
            string debugOutputString =
                $"- begin ViSCARecorder.Recorder19.FixedUpdate\n"
                + $"\n"
                + $"{recordString}\n"
                + $"\n"
                + $"- end ViSCARecorder.Recorder19.FixedUpdate\n"
            ;
