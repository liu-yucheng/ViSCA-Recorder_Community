...
using ViSCARecorder;
using ViSCARecorder.Recorder10NameSpace;

namespace ViSCARecorder
{
    public class Recorder10 : MonoBehaviour
    {
        ...
        private void Start_DebugOut()
        {
            ...
            string debugOutString =
                "- begin ViSCARecorder.Recorder10.Start\n"
                + "\n"
                + "record: {...}\n"
                + "\n"
                + "- end ViSCARecorder.Recorder10.Start\n"
            ;
        ...
        private void FixedUpdate_DebugOut()
        {
            ...
            string debugOutString =
                $"- begin ViSCARecorder.Recorder10.FixedUpdate\n"
                + $"\n"
                + $"{recordString}\n"
                + $"\n"
                + $"- end ViSCARecorder.Recorder10.FixedUpdate\n"
            ;
