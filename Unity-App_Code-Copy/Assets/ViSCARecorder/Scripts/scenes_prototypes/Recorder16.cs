...
using ViSCARecorder.Recorder16_;
using Face = ViSCARecorder.Recorder16_.Face;
using Record = ViSCARecorder.Recorder16_.Record;
using Capture = ViSCARecorder.Recorder16_.Capture;

namespace ViSCARecorder
{
    public class Recorder16 : MonoBehaviour
    {
        // Shared (public).
        ...
        private void Start_Texts()
        {
            ...
            string debugOutputString =
                "- begin ViSCARecorder.Recorder16.Start\n"
                + "\n"
                + "record: {...}\n"
                + "\n"
                + "- end ViSCARecorder.Recorder16.Start\n"
            ;
        ...
        private void FixedUpdate_Texts()
        {
            ...
            string debugOutputString =
                $"- begin ViSCARecorder.Recorder16.FixedUpdate\n"
                + $"\n"
                + $"{recordString}\n"
                + $"\n"
                + $"- end ViSCARecorder.Recorder16.FixedUpdate\n"
            ;
        ...
        private void FixedUpdate_Capture()
        {
            ...
            capture_Task.FixedUpdate(time_DeltaTimeSeconds);
        }
        ...
        private void Start_Record_SetupFileNames()
        {
            ...
            record_Task.fileName = record_FileName;
        }

        private void Start_Capture_SetupFolders()
        {
            string folderName = $"{time_Now:yyyyMMdd}-{time_Now:HHmmss}-{time_Now:ffffff}-utc{time_UTCOffset:hhmm}";
            folderName = $"visca-capture-record-{folderName}";
            __.ReplaceInvalidCharsWith("_", ref folderName);
