...
namespace ViSCARecorder.Recorder16_
{
    [Serializable]
...
namespace ViSCARecorder.Recorder16_.Face
{
...
namespace ViSCARecorder.Recorder16_.Record
{
    [Serializable]
    ...
    public class SpatialPose
    {
        ...
        )
        {
            ...
            Recorder16_.__.FindEulerAnglesDiff(previous.rotation_raw, current.rotation_raw, out Vector3 rotationDiff);
            ...
            Recorder16_.__.FilterEMA(0.5f, positionRaw, previous.position, out current.position);
            Recorder16_.__.FilterEMA(0.5f, rotationRaw, previous.rotation, out current.rotation);
            Recorder16_.__.FilterEMA(0.5f, velocityRaw, previous.velocity, out current.velocity);
            Recorder16_.__.FilterEMA(0.5f, angularVelocityRaw, previous.angular_velocity, out current.angular_velocity);
            Recorder16_.__.FilterEMA(0.5f, accelerationRaw, previous.acceleration, out current.acceleration);
            Recorder16_.__.FilterEMA(0.5f, angluarAccelerationRaw, previous.angular_acceleration, out current.angular_acceleration);
        }
...
namespace ViSCARecorder.Recorder16_.Capture
{
    public class CaptureTask
    {
        ...
        public void FixedUpdate(float deltaTimeSeconds)
        {
            if (loopEnabled)
            {
                ...
                {
                    countdown = intervalSeconds;
                    AsyncGPUReadback.Request(camera.targetTexture, 0, Callback);
                }
        ...
        private void Callback(AsyncGPUReadbackRequest request)
        {
            ...
            {
                NativeArray<byte> pixelNativeArray = request.GetData<byte>(0);
        ...
        private void FindPath(out string path)
        {
            ...
            Recorder16_.__.ReplaceInvalidCharsWith("_", ref fileName);
