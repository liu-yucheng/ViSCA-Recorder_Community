...
namespace ViSCARecorder.Recorder18_
{
    [Serializable]
...
namespace ViSCARecorder.Recorder18_.Face
{
...
namespace ViSCARecorder.Recorder18_.Record
{
    [Serializable]
    ...
    public class SpatialPose
    {
        ...
        )
        {
            ...
            Recorder18_.__.FindEulerAnglesDiff(previous.rotation_raw, current.rotation_raw, out Vector3 rotationDiff);
            ...
            Recorder18_.__.FilterEMA(0.5f, positionRaw, previous.position, out current.position);
            Recorder18_.__.FilterEMA(0.5f, rotationRaw, previous.rotation, out current.rotation);
            Recorder18_.__.FilterEMA(0.5f, velocityRaw, previous.velocity, out current.velocity);
            Recorder18_.__.FilterEMA(0.5f, angularVelocityRaw, previous.angular_velocity, out current.angular_velocity);
            Recorder18_.__.FilterEMA(0.5f, accelerationRaw, previous.acceleration, out current.acceleration);
            Recorder18_.__.FilterEMA(0.5f, angluarAccelerationRaw, previous.angular_acceleration, out current.angular_acceleration);
        }
...
namespace ViSCARecorder.Recorder18_.Capture
{
    public class CaptureTask
    {
        ...
        private void FindPath(out string path)
        {
            ...
            Recorder18_.__.ReplaceInvalidCharsWith("_", ref fileName);
