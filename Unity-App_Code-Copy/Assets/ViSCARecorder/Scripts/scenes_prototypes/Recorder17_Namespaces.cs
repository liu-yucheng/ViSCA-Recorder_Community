...
namespace ViSCARecorder.Recorder17_
{
    [Serializable]
...
namespace ViSCARecorder.Recorder17_.Face
{
...
namespace ViSCARecorder.Recorder17_.Record
{
    [Serializable]
    ...
    public class SpatialPose
    {
        ...
        )
        {
            ...
            Recorder17_.__.FindEulerAnglesDiff(previous.rotation_raw, current.rotation_raw, out Vector3 rotationDiff);
            ...
            Recorder17_.__.FilterEMA(0.5f, positionRaw, previous.position, out current.position);
            Recorder17_.__.FilterEMA(0.5f, rotationRaw, previous.rotation, out current.rotation);
            Recorder17_.__.FilterEMA(0.5f, velocityRaw, previous.velocity, out current.velocity);
            Recorder17_.__.FilterEMA(0.5f, angularVelocityRaw, previous.angular_velocity, out current.angular_velocity);
            Recorder17_.__.FilterEMA(0.5f, accelerationRaw, previous.acceleration, out current.acceleration);
            Recorder17_.__.FilterEMA(0.5f, angluarAccelerationRaw, previous.angular_acceleration, out current.angular_acceleration);
        }
...
namespace ViSCARecorder.Recorder17_.Capture
{
    public class CaptureTask
    {
        ...
        private void FindPath(out string path)
        {
            ...
            Recorder17_.__.ReplaceInvalidCharsWith("_", ref fileName);
