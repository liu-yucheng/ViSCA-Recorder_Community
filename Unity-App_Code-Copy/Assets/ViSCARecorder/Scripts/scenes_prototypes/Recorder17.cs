...
using ViSCARecorder.Recorder17_;
using Face = ViSCARecorder.Recorder17_.Face;
using Record = ViSCARecorder.Recorder17_.Record;
using Capture = ViSCARecorder.Recorder17_.Capture;

namespace ViSCARecorder
{
    public class Recorder17 : MonoBehaviour
    {
        // Shared (public).
        ...
        // Capturing (public).
        public GameObject capture_MainCameraObject;
        public GameObject capture_HUDCameraObject;
        ...
        private Capture::CaptureTask capture_MainTask;
        private Capture::CaptureTask capture_HUDTask;
        ...
        private void Start_Texts()
        {
            ...
            string debugOutputString =
                "- begin ViSCARecorder.Recorder17.Start\n"
                + "\n"
                + "record: {...}\n"
                + "\n"
                + "- end ViSCARecorder.Recorder17.Start\n"
            ;
        ...
        private void FixedUpdate_Texts()
        {
            ...
            string debugOutputString =
                $"- begin ViSCARecorder.Recorder17.FixedUpdate\n"
                + $"\n"
                + $"{recordString}\n"
                + $"\n"
                + $"- end ViSCARecorder.Recorder17.FixedUpdate\n"
            ;
        ...
        private void Start_Capture()
        {
            ...
            capture_MainTask = new();
            capture_HUDTask = new();
            Start_Capture_SetupFolders();
            
            capture_MainTask.intervalSeconds = capture_IntervalSeconds;
            capture_MainTask.camera = capture_MainCameraObject.GetComponent<Camera>();
            capture_MainTask.countdown = capture_IntervalSeconds;
            
            capture_HUDTask.intervalSeconds = capture_IntervalSeconds;
            capture_HUDTask.camera = capture_HUDCameraObject.GetComponent<Camera>();
            capture_HUDTask.countdown = capture_IntervalSeconds;
        }
        ...
        private void FixedUpdate_Capture()
        {
            ...
            capture_MainTask.FixedUpdate(time_DeltaTimeSeconds);
            capture_HUDTask.FixedUpdate(time_DeltaTimeSeconds);
        }
        ...
        private void OnApplicationFocus_Capture(bool focus)
        {
            if (!focus)
            {
                capture_MainTask.Join();
                capture_HUDTask.Join();
            }
        }
        ...
        {
            sickness = 0f;
            float weakThreshold = 0.5f - 1e-3f;
        ...
        private void Start_Capture_SetupFolders()
        {
            ...
            __.ReplaceInvalidCharsWith("_", ref mainFolderName);
            mainFolderName = Path.Combine(folderName, mainFolderName);
            Directory.CreateDirectory(mainFolderName);
            capture_MainTask.folderName = mainFolderName;
            capture_MainTask.folderStartTimeSeconds = time_Seconds;

            string hudFolderName = "hud";
            __.ReplaceInvalidPathCharsWith("_", ref hudFolderName);
            hudFolderName = Path.Combine(folderName, hudFolderName);
            Directory.CreateDirectory(hudFolderName);
            capture_HUDTask.folderName = hudFolderName;
            capture_HUDTask.folderStartTimeSeconds = time_Seconds;
        }
