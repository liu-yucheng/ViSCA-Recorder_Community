...
{
    public class Vehicle4 : MonoBehaviour
    {
        ...
        private float Vehicle_Refresh_Interval_Seconds = 0.03_333_333f; // 30 Hz.
        private float Vehicle_RefreshCountdown_Seconds = 0f;

        private Autopilot3 Autopilot_Instance;
        ...
        void Start()
        {
            ...
            Autopilot_Instance = Autopilot_Object.GetComponent<Autopilot3>();
        ...
        void FixedUpdate()
        {
            ...
            {
                Vehicle_RefreshCountdown_Seconds = Vehicle_Refresh_Interval_Seconds;
                FindDriveInput();
                RefreshWheels();
                FindSicknessInput();
            }
